			...
			<div class="header">
				...
				<div class="header-nav">
					<ul class="header-nav-list">
						<li class="header-nav-list-item"><a class="header-nav-list-item-wrap--current" href="DUMMY">nav</a></li>
						<li class="header-nav-list-item"><a class="header-nav-list-item-wrap" href="DUMMY">nav</a></li>
						<li class="header-nav-list-item"><a class="header-nav-list-item-wrap" href="DUMMY">nav</a></li>
						<li class="header-nav-list-item"><a class="header-nav-list-item-wrap" href="DUMMY">nav</a></li>
						<li class="header-nav-list-item"><a class="header-nav-list-item-wrap" href="DUMMY">nav</a></li>
					</ul>
			...
			<div class="mainContainer">
				<div class="mainContainer-wrap">
					...
					<div class="mainColumn">
						...
						<div class="section">
							<h2 class="headingTypeH2">NAVER女子まとめ</h2>
							<ul class="contentsList01">
								<li class="contentsList01-item">
									<a href="DUMMY" class="contentsList01-item-wrap">
							...
							<p class="indexPageLink"><a href="DUMMY">もっと見る</a></p>
						</div>
						<!-- メインコンテンツ　(番号付きリスト) -->
						<div class="section">
							<h2 class="headingTypeH2">アクセスランキング</h2>
							<ol class="contentsList02">
								<li class="contentsList02-item"><a href="DUMMY">あああああああああああああああああ</a></li>
								<li class="contentsList02-item"><a href="DUMMY">いいいいいいいいいいいいいいいいい</a></li>
								<li class="contentsList02-item"><a href="DUMMY">ううううううううううううううううう</a></li>
								<li class="contentsList02-item"><a href="DUMMY">えええええええええええええええええ</a></li>
								<li class="contentsList02-item"><a href="DUMMY">おおおおおおおおおおおおおおおおお</a></li>
								<li class="contentsList02-item"><a href="DUMMY">かかかかかかかかかかかかかかかかか</a></li>
								<li class="contentsList02-item"><a href="DUMMY">ききききききききききききききききき</a></li>
								<li class="contentsList02-item"><a href="DUMMY">くくくくくくくくくくくくくくくくく</a></li>
								<li class="contentsList02-item"><a href="DUMMY">けけけけけけけけけけけけけけけけけ</a></li>
								<li class="contentsList02-item"><a href="DUMMY">こここここここここここここここここ</a></li>
							</ol>
						</div>
					</div>
					<!-- サブカラム -->
					<div class="subColumn">
						...
						<div class="fortuneBox">
							<h2 class="fortuneBox-title">12星座の今日の運勢</h2>
							<form action="" method="get" id="frm">
								<select class="fortuneBox-select">
									<option value="0">今日の一位は？</option>
								...
								<p class="fortuneBox-btn"><a href="javascript:void(0)" onClick="submitForm();" class="fortuneBox-btn-wrap">占い</a></p>
							</form>
						</div>
						<!-- SNS -->
						<ul class="snsList01">
							<li class="snsList01-twitter">Twitterのソースが入ります。</li>
							<li class="snsList01-facebook">facebookのソースが入ります。</li>
						</ul>
						<!-- デバイス誘導 -->
						<div class="noticeBox02">
							<h2 class="noticeBox02-title">カワイイとハッピーがいっぱい！<br>
							ガールズニュースアプリ</h2>
							<ul class="noticeBox02-list01">
								<li class="noticeBox02-list01-item"><a href="DUMMY" class="noticeBox02-list01-item-wrap">iPhoneアプリ</a></li>
					...
					<p class="pagetopAnchor"><a class="pagetopAnchor-link" href="DUMMY">↑</a></p>
				</div>
			</div>
			<!-- フッター -->
			<div class="footer">
				<ul class="footer-siteMap">
					<li class="footer-siteMap-item"><a class="footer-siteMap-item-wrap" href="DUMMY">siteMap</a></li>
					<li class="footer-siteMap-item"><a class="footer-siteMap-item-wrap" href="DUMMY">siteMap</a></li>
					<li class="footer-siteMap-item"><a class="footer-siteMap-item-wrap" href="DUMMY">siteMap</a></li>
					<li class="footer-siteMap-item"><a class="footer-siteMap-item-wrap" href="DUMMY">siteMap</a></li>
					<li class="footer-siteMap-item"><a class="footer-siteMap-item-wrap" href="DUMMY">siteMap</a></li>
				...
				<ul class="footer-otherLink">
					<li class="footer-otherLink-item"><a class="footer-otherLink-item-wrap" href="DUMMY">otherLink</a></li>
					<li class="footer-otherLink-item"><a class="footer-otherLink-item-wrap" href="DUMMY">otherLink</a></li>
					<li class="footer-otherLink-item"><a class="footer-otherLink-item-wrap" href="DUMMY">otherLink</a></li>
					<li class="footer-otherLink-item"><a class="footer-otherLink-item-wrap" href="DUMMY">otherLink</a></li>
					<li class="footer-otherLink-item"><a class="footer-otherLink-item-wrap" href="DUMMY">otherLink</a></li>
